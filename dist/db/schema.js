...
exports.chargingStations = (0, pg_core_1.pgTable)('charging_stations', {
    ...
    operatingHours: (0, pg_core_1.jsonb)('operating_hours').default((0, drizzle_orm_1.sql) `'{"monday":"24/7","tuesday":"24/7","wednesday":"24/7","thursday":"24/7","friday":"24/7","saturday":"24/7","sunday":"24/7"}'::jsonb`),
    amenities: (0, pg_core_1.jsonb)('amenities').default((0, drizzle_orm_1.sql) `'[]'::jsonb`),
...
exports.chargingSessions = (0, pg_core_1.pgTable)('charging_sessions', {
    ...
    startMeterReading: (0, pg_core_1.decimal)('start_meter_reading', { precision: 10, scale: 3 }),
    endMeterReading: (0, pg_core_1.decimal)('end_meter_reading', { precision: 10, scale: 3 }),
    energyDelivered: (0, pg_core_1.decimal)('energy_delivered', { precision: 10, scale: 3 }),
    verificationStatus: (0, pg_core_1.varchar)('verification_status', { length: 30 }).default('pending'),
    startVerificationAttempts: (0, pg_core_1.integer)('start_verification_attempts').default(0),
    endVerificationAttempts: (0, pg_core_1.integer)('end_verification_attempts').default(0),
    manualEntryUsed: (0, pg_core_1.boolean)('manual_entry_used').default(false),
    startReadingConfidence: (0, pg_core_1.decimal)('start_reading_confidence', { precision: 5, scale: 4 }),
    endReadingConfidence: (0, pg_core_1.decimal)('end_reading_confidence', { precision: 5, scale: 4 }),
    meterValidated: (0, pg_core_1.boolean)('meter_validated').default(false),
    validationWarnings: (0, pg_core_1.jsonb)('validation_warnings').default((0, drizzle_orm_1.sql) `'[]'::jsonb`),
    ...
    verificationIdx: (0, pg_core_1.index)('sessions_verification_idx').on(table.verificationStatus),
...
exports.stationOwners = (0, pg_core_1.pgTable)('station_owners', {
    ...
    averageRating: (0, pg_core_1.decimal)('average_rating', { precision: 3, scale: 2 }).default('0'),
    isActive: (0, pg_core_1.boolean)('is_active').default(true),
    permissions: (0, pg_core_1.jsonb)('permissions').notNull().default((0, drizzle_orm_1.sql) `'["manage_own_stations"]'::jsonb`),
...
exports.admins = (0, pg_core_1.pgTable)('admins', {
    ...
    permissions: (0, pg_core_1.jsonb)('permissions').notNull().default((0, drizzle_orm_1.sql) `'["manage_owners","manage_users","view_analytics"]'::jsonb`),
    isActive: (0, pg_core_1.boolean)('is_active').default(true),
...
exports.payments = (0, pg_core_1.pgTable)('payments', {
    ...
    sessionIdIdx: (0, pg_core_1.index)('payments_session_id_idx').on(table.sessionId),
...
exports.stationsRelations = (0, drizzle_orm_2.relations)(exports.chargingStations, ({ many, one }) => ({
    queues: many(exports.queues),
    sessions: many(exports.chargingSessions),
    payments: many(exports.payments),
...
exports.queuesRelations = (0, drizzle_orm_2.relations)(exports.queues, ({ one, many }) => ({
...
exports.sessionsRelations = (0, drizzle_orm_2.relations)(exports.chargingSessions, ({ one }) => ({
    station: one(exports.chargingStations, {
...
exports.ownersRelations = (0, drizzle_orm_2.relations)(exports.stationOwners, ({ many }) => ({
